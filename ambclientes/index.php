...
//Abrir el archivojson.txt para recuperar los datos previos
if(file_exists("archivojson.txt")){
    //Abrir el archivo y almacenar el json en jsonClientes
    $jsonClientes = file_get_contents("archivojson.txt");
...
if($_POST){
    ...
    if(isset($_GET["pos"]) && $_GET["pos"] >= 0){
        ...
        if($_FILES["archivo"]["error"] !== UPLOAD_ERR_OK){
            ...
            //Eliminar la imagen anterior si se adjunta una nueva
    ...
    //Almacenar el json en archivojson.txt
    file_put_contents("archivojson.txt", $jsonClientes);
}
...
if(isset($_GET["eliminar"]) && $_GET["eliminar"] >= 0){
    ...
    //Almacenar el json en el archivojson.txt
    file_put_contents("archivojson.txt", $jsonClientes);
                    ...
                    <tbody>
                        <?php foreach($aClientes as $pos => $cliente): ?>
                            <tr>
                                ...
                                <td><img src="imagenes/sinimagen.jpeg" class="img-thumbnail"></td>
                                <?php else: ?>
