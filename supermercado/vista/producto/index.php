                    ...
                    <?php if (!empty($dato)): ?>
                        <?php foreach($dato as $producto): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $v["txtRasonSocial"]; ?></td>
                                <td><?php echo $v["txtNombre"]; ?></td>
                                <td><?php echo $v["txtPrecio"]; ?></td>
                                <td>
                                    <a value="habilitar" name="btnEditar" href="/php/mvc/index.php?m=editarSucu&id=<?php echo $v["id"];?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="/php/mvc/index.php?m=eliminarProd&id=<?php echo $v["id"];?>"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
