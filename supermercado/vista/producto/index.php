                    ...
                    <?php if (!empty($dato)): ?>
                        <?php foreach($dato as $producto): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a value="habilitar" name="btnEditar" href="/php/supermercado/index.php?m=editarProd&idProducto=<?php echo $v["idProducto"];?>"><i class="fa-solid fa-pen-to-square fa-lg"></i></a>
                                    <a href="/php/supermercado/index.php?m=eliminarProd&idProducto=<?php echo $v["idProducto"];?>"><i class="fa-solid fa-trash-can fa-lg"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php endforeach; ?>
